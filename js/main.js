...
function validate() {
    ...
    if (username == "admin" && password == "123456") {
      ...
      setTimeout(function(){
        ...
        window.location = "doc/index-admin.html";
        return true;
       
    }
       //Đặt 1 Staff ảo để đăng nhập quản trị
       if (username == "staff" && password == "888888") {
        swal({
            title: "",
            text: "Xin chào Đỗ Chinh",
            icon: "success",
            close: true,
            button: false,
          });
        window.location = "doc/index-staff.html";
        return true;
